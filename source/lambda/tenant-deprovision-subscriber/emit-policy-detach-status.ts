...
export type PolicyDetachStatusPhase = 'policy_detach_started' | 'policy_detach_complete' | 'policy_detach_failed';

export async function emitPolicyDetachStatus(detail: {
    tenantTemplateInstanceId: string;
    phase: PolicyDetachStatusPhase;
    message?: string;
